...
class DatabaseArticleHelper {
  static DatabaseArticleHelper _databaseArticleHelper;
  static Database _database;

  DatabaseArticleHelper._createObject();

  factory DatabaseArticleHelper() {
    if (_databaseArticleHelper == null) {
      _databaseArticleHelper = DatabaseArticleHelper._createObject();
    }
    return _databaseArticleHelper;
  }
  ...
  /// metode untuk menjadlankan query database, untuk menyimpan data
